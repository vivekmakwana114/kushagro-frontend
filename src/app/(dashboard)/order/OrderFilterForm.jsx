...
const OrderFilterForm = ({ onCancel, onApply }) => {
  // State for the form
  ...
  const handleApply = () => {
    ...
    const isOrderStatusAll =
      orderStatus.length === 1 && orderStatus[0] === "all";
    ...
    console.log("Applied Order Filters:", filterData);
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        ...
        <div className="space-y-6">
          ...
          <CheckboxGroup
            ...
            value={orderStatus}
            onChange={(val) => {
              if (val.length === 0) setOrderStatus(["all"]);
              else setOrderStatus(val);
            }}
            singleSelect={true}
          />
